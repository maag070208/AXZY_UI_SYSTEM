...
- **years** — Click the year in the header to switch to a year selection view (12-year grid).
- **months** — Click the month name in the header (or pick a year) to switch to a month selection view (12-month grid, same style as the year grid). Flow: header → year → month → days.
