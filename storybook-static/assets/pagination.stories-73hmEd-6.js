import{j as r,r as m}from"./iframe-BUyFEAH8.js";import{I as P}from"./pagination-BRK0WJhw.js";import"./preload-helper-C1FmrZbK.js";import"./select-ZaK3Plt5.js";const _={title:"Components/Data Display/ITPagination",component:P,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{currentPage:{control:"number"},totalPages:{control:"number"},siblingCount:{control:"number"},color:{control:"select",options:["primary","secondary","success","danger","warning","info","purple"]}}},l=e=>{const[a,t]=m.useState(e.currentPage||1);return r.jsx(P,{...e,currentPage:a,onPageChange:s=>t(s)})},n={render:e=>r.jsx(l,{...e}),args:{currentPage:1,totalPages:5,color:"primary"}},o={render:e=>r.jsx(l,{...e}),args:{currentPage:1,totalPages:50,siblingCount:1,color:"primary"}},g={render:e=>r.jsx(l,{...e}),args:{currentPage:25,totalPages:50,siblingCount:1,color:"primary"}},c={render:e=>{const[a,t]=m.useState(1),[s,O]=m.useState(10),u=500,D=Math.ceil(u/s);return r.jsx(P,{...e,currentPage:a,totalPages:D,onPageChange:p=>t(p),itemsPerPageOptions:[10,20,30,50],itemsPerPage:s,onItemsPerPageChange:p=>{O(p),t(1)},totalItems:u})},args:{color:"primary",className:"w-[600px]"}},i={render:e=>r.jsx("div",{className:"flex flex-col gap-4",children:["primary","secondary","success","danger","warning","info","purple"].map(a=>r.jsxs("div",{className:"flex gap-4 items-center",children:[r.jsx("span",{className:"w-20 text-sm font-bold text-gray-500 capitalize",children:a}),r.jsx(l,{...e,color:a})]},a))}),args:{currentPage:1,totalPages:5}};var d,x,y;n.parameters={...n.parameters,docs:{...(d=n.parameters)==null?void 0:d.docs,source:{originalSource:`{
...
}`,...(W=(M=i.parameters)==null?void 0:M.docs)==null?void 0:W.source}}};const R=["Default","ManyPages","MiddlePageOpened","WithItemsPerPage","Colors"];export{i as Colors,n as Default,o as ManyPages,g as MiddlePageOpened,c as WithItemsPerPage,R as __namedExportsOrder,_ as default};
